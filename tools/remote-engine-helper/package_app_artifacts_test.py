...
""",
    ...
    def test_release_paths_package_and_verify_remote_engine_artifacts(self):
        ...
        self.assertIn("- name: Package remote engine artifacts", workflow)
        self.assertIn("FANTASTTY_REMOTE_ENGINE_BUILD_ROOT: ${{ runner.temp }}/fantastty-remote-engine-artifacts", workflow)
        self.assertIn("run: make remote-engine-app-artifacts", workflow)
